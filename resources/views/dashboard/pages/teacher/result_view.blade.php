...
@section('main')
    ...
    <div class="right_content">
        ...
        <div class="display-grid three-grid grid-column-20">
            <x-dashboard.organisms.result-view-subject-table-sm :subjects="$subjects" :year="$year" :type="$type" :current_subject_id="$current_subject_id" :current_section_id="$current_section_id"/>

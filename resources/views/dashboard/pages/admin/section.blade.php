...
@section('main')
    ...
    <div class="right_content">
        ...
        <div class="display-grid three-grid">
            <x-dashboard.organisms.section-form-sm :teachers="$teachers"/>
            <x-dashboard.organisms.table-sm :sections="$sections"/>
            <x-dashboard.organisms.section-form-edit :teachers="$teachers" :sections="$sections"/>
        </div> 
    </div>
@endsection

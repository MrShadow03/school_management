...
@section('main')
    ...
    <div class="right_content">
        ...
        <div class="display-grid three-grid">
            <x-dashboard.organisms.doctors-form-sm :doctors="$doctors" :departments="$departments" :assistants="$assistants" />
            <x-dashboard.organisms.doctors-table-sm :doctors="$doctors" />
        </div> 
    </div>
@endsection

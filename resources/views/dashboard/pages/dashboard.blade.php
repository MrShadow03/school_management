...
@section('main')
    ...
    <div class="right_content">
        ...
        <div class="bar-wrapper print-none">
        ...
        @php
            $doctor = isset($doctor) ? $doctor : 'All appointments';
        @endphp
        <x-dashboard.organisms.appointments-table-sm :appointments="$appointments" :doctors="$doctors" :doctor="$doctor"/>
        @endif
    </div>
@endsection
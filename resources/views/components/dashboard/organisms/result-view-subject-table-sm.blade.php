...
<div class="table_box grid-row1" style="padding-inline: 15px;">
    <div class="table-wrapper">
        <div>            
            ...
            <a href="{{ route('teacher.result_upload.index',[$year,$type,$subject->section->id,$subject->subject->id]) }}" class="w-100 row border-top row-hover p-inline {{ $subject->subject->id == $current_subject_id && $subject->section->id == $current_section_id ? 'row-active' : '' }}">
